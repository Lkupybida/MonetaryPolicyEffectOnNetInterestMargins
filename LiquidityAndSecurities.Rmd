...
generate_stargazer_with_titles(list(OLS_model, FE_model, Averaged_model), c('OLS', 'FE', 'Averaged'))
```
...
p <- ggplot(result, aes(x = date)) + 
  ...
  geom_line(aes(y = SEC * 0.865 + 0.074, color = "SEC adj.", linetype = "SEC adj."), linewidth = 0.8) + 
